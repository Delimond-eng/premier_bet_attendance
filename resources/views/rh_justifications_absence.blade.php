...
@section("content")
    <div class="content" id="App" v-cloak data-kind="absence">
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">Justifications (absence)</h2>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Justification absence</li>
                    </ol>
                </nav>
            </div>
